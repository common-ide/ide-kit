...
export const StyledModalContaner = styled.div.attrs(props => ({
  style: props.style || {} // 优先级会高一些，行内样式
}))`
  width: auto;
`;

export const StyledContentWrap = styled.div.attrs(props => ({
  style: props.style || {} // 优先级会高一些，行内样式
}))`
`;
...
export const StyledModalCanvas = styled.canvas.attrs(props => ({
  style: props.style || {} // 优先级会高一些，行内样式
})) <IStyledProps>`
  position: fixed;
  top: ${(props: IStyledProps) =>
